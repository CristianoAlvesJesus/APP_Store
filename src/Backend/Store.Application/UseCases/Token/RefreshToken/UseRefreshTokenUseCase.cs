...
public class UseRefreshTokenUseCase : IUseRefreshTokenUseCase
{
    ...
    public UseRefreshTokenUseCase(IUnitOfWork unitOfWork,
    ...
    public async Task<ResponseTokensJson> Execute(RequestNewTokenJson request)
    {
        ...
        var refreshTokenValidUntil = refreshToken.CreatedOn.AddDays(StoreRuleConstants.REFRESH_TOKEN_EXPIRATION_DAYS);
